...
describe Bech32 do
  describe ".decode" do
    ...
    it "raises if the string is too short" do
      expect_raises(Bech32::LengthException, "'blabla1' is too short") do
    ...
    it "raises with a mixed-case string" do
      expect_raises(Bech32::CaseException, "Mixed-case string") do
        Bech32.decode("aBcDeFgH")
      end
    end

    it "raises if no separator character could be found" do
      expect_raises(Bech32::PrefixException, "No separator character") do
        Bech32.decode("abcdefghijklmnopqrstuvwxyz")
      end
    end

    it "raises without a prefix" do
      expect_raises(Bech32::PrefixException, "Missing prefix") do
        Bech32.decode("1abcdefghijklmnopqrstuvwxyz")
      end
    end

    it "raises if data is too short" do
      expect_raises(Bech32::LengthException, "Data part 'check' is too short") do
